...
const allNavItems: NavItem[] = [
  ...
  },
  {
    ...
    subItems: [
      { name: "Daftar Staff", path: "/staff" },
      { name: "Tambah Staff", path: "/staff/new" },
    ],
  },
  {
    ...
    name: "Stok",
    subItems: [
      { name: "Stok Harian", path: "/stocks", pro: false },
      { name: "Riwayat Stok", path: "/stocks/history", pro: false },
    ],
  },
  {
  ...
  },
  {
    ...
    name: "Buku Besar",
    subItems: [
      { name: "Entry Harian", path: "/ledger", pro: false },
      { name: "Laporan Bulanan", path: "/ledger/monthly", pro: false },
    ],
  },
  {
...
const AppSidebar: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // This is intentional synchronization with URL pathname - avoid cascading renders
    // eslint-disable-next-line react-hooks/set-state-in-effect
    setOpenSubmenu((current) => {
      // Compare current and new values
      const isSame =
        (current === null && matchedSubmenu === null) ||
        (current !== null && matchedSubmenu !== null &&
          current.type === matchedSubmenu.type &&
          current.index === matchedSubmenu.index);

      return isSame ? current : matchedSubmenu;
    });
  }, [pathname, isActive]);
